defmodule Vmemo.Chat.Message do
  ...
  oban do
    triggers do
      trigger :respond do
        ...
        worker_module_name Vmemo.Chat.Message.Workers.Respond
        scheduler_module_name Vmemo.Chat.Message.Schedulers.Respond
  ...
  actions do
    ...
    update :respond do
      ...
      transaction? false
      change Vmemo.Chat.Message.Changes.Respond
    end
  ...
  attributes do
    ...
    attribute :source, Vmemo.Chat.Message.Types.Source do
      allow_nil? false
      public? true
      default :user
    end
  ...
  relationships do
    belongs_to :conversation, Vmemo.Chat.Conversation do
      public? true
      allow_nil? false
    end
