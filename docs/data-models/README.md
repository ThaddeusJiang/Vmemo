...
**服务模块**: `Vmemo.PhotoService.TsPhoto`
...
**服务模块**: `Vmemo.PhotoService.TsNote`
...
| 照片 | photos | Vmemo.Photos.Photo | photos | Vmemo.PhotoService.TsPhoto |
| 笔记 | notes | Vmemo.Photos.Note | notes | Vmemo.PhotoService.TsNote |
